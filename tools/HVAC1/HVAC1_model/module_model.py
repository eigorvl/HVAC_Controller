## @package  module_model.py
#  @brief содержит функции вычисления температур в системах HVAC 
#  Температуры вычисляются исходя из предыдущих значений, характеристик
#  и состояния системы
...
###################################
# @brief функция вычисления температуры на выходе пластинчатого рекуператора воздух/воздух с учетом байпаса
#
# @param VentilationSystem структура вентиляционной системы
# @return VentilationSystem структура вентиляционной системы        
###################################
...
###################################
# @brief функция вычисления температуры на выходе пластинчатого рекуператора воздух/воздух с учетом байпаса новая правильная версия
#
# @param VentilationSystem структура вентиляционной системы
# @return VentilationSystem структура вентиляционной системы          
#  
...
###################################
# @brief функция вычисления температуры на на теплообменнике вода/воздух 
#
# @param VentilationSystem структура вентиляционной системы
# @return VentilationSystem структура вентиляционной системы          
#
...
###################################
# @brief функция вычисления температуры на выходе канального кондиционера летом
#
# @param VentilationSystem структура вентиляционной системы
# @return VentilationSystem структура вентиляционной системы          
#
...
###################################
# @brief функция вычисления температуры на выходе электрокалорифера 
#
# @param VentilationSystem структура вентиляционной системы
# @return VentilationSystem структура вентиляционной системы          
#            
...
###################################
# @brief функция вычисления температуры на выходе теплообменника вода/воздух Фанкойла
#
# @param FancoilSystem структура вентиляционной системы
# @return FancoilSystem структура вентиляционной системы
#  
###################################
...
###################################
# @brief функция вычисления температуры на выходе электронагревателя Фанкойла
#
# @param FancoilSystem структура вентиляционной системы
# @return FancoilSystem структура вентиляционной системы
#  
...
###################################
# @brief функция вычисления концентрации СО2 в зависимости от количества людей и объема подаваемого воздуха v.2
#
# @param FancoilSystem структура  вентиляционной системы 
# @return FancoilSystem структура вентиляционной системы 
#     
...
###################################
# @brief функция вычисления общеего объема поданого  наружного воздуха v.1
#
# @param FancoilSystem структура вентиляционной системы 
# @return FancoilSystem структура вентиляционной системы 
#  
...
###################################
# @brief функция вычисления затраченой энергии на подогрев  воздуха v.1
#
# @param FancoilSystem структура вентиляционной системы 
# @return FancoilSystem структура вентиляционной системы  
#  
...
###################################
# @brief функция вычисления утечки температуры (энергии) из помещения
#
# @param T, S, m, K 
...
###################################
# @brief функция вычисления утечки температуры (энергии) из помещения через сены
#
# @param VentilationSystem структура  системы вентиляции  
# @return VentilationSystem структура  системы вентиляции
#
#       S * dTул     Дж
#   Q = --------    ----  [Вт]
#         K          с
...
###################################
# @brief функция вычисления температуры в помещении при подаче теплого воздуха подсчитываем каждые 3 сек
# @param VentilationSystem структура  системы вентиляции  
# @return VentilationSystem структура  системы вентиляции
#
#  ПВ  Система
...
###################################
# @brief функция вычисления температуры в помещении при подаче теплого воздуха подсчитываем каждые 3 сек
# @param FancoilSystem структура  системы вентиляции  
# @return FancoilSystem структура  системы вентиляции  
#
#  Фанкоил
#  
#            -S * dTул     
...
###################################
# @brief функция вычисления температуры в помещении при подаче горячей воды подсчитываем каждые 3 сек
# @param HeaterSystem структура отопительной системы  
# @return HeaterSystem структура отопительной системы  
#  
#            -S * dTул     
#   Q_loss =  --------  * dt  [Дж]
#                K         
...
###################################
# @brief функция вычисления температур в системе отопления подсчитываем каждые 3 сек
# @param HeaterSystem структура отопительной системы  
# @return HeaterSystem структура отопительной системы  
#
###################################
...
###################################
# @brief функция вычисления уставки теплоносителя в зависимости от уличной температуры
# @param HeaterSystem структура отопительной системы  
# @return HeaterSystem структура отопительной системы
# 
...
###################################
# @brief функция вычисления Т Тестовая
###################################
def calculate_T1(T):
    T = T + 2
    return T
...
###################################
# @brief функция преобразования в int16
# 
###################################
def to_int16(value):
