...
#################################################
# @brief Функция для шапки логирования HVAC2
#################################################
def log_system_state_Head_HVAC2():
...
#################################################
# @brief Функция для логирования HVAC2
#################################################
def log_system_state_HVAC2(system: module_model.VentilationSystem):
...
if __name__ == "__main__":
    ...
    file_handler_table = logging.FileHandler("HVAC2_table.log", encoding="utf-8")
    ...
    file_handler_error = logging.FileHandler("HVAC2_error.log", encoding="utf-8")
...
##            print("interval_period:", interval_period)
            ...
            nB1.water_damper.position = AI[0]
            ...
            module_model.HeatExcanger_water_air_Calc(nB1)            # работа теплообменника вода/воздух
