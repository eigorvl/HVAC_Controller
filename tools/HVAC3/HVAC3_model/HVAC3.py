...
#################################################
def log_system_state_Head_HVAC3():
    ...
    header = f"{'Дата':<12}{'Время':<10}{'П1':<4}" \
             f"{'Y1':<6}{'Y3':<6}{'T1':<6}{'T2':<6}{'T3':<8}{'CO2':<6}{'T5':<6}"\
...
#################################################
def log_system_state_HVAC3(system: module_model.FancoilSystem):
...
if __name__ == "__main__":
    ...
    file_handler_table = logging.FileHandler("HVAC3_table.log", encoding="utf-8")
    ...
    file_handler_error = logging.FileHandler("HVAC3_error.log", encoding="utf-8")
...
##            print("interval_period:", interval_period)
            ...
            module_model.HeatExchanger_Fancoil_water_air_Calc(Fancoil)    # функция вычисления температуры на выходе водяного теплообменника Фанкойла
            ...
            log_system_state_HVAC3(Fancoil)
